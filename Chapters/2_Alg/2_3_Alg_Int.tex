...
% Before we begin, we need an important result on finitely generated abelian groups.

% \begin{boxproposition}
    
% \end{boxproposition}

\begin{boxproposition}\label{Ch2:Prop:CharacterisationofAlgInt}
...
\begin{boxproposition}[Ring Properties]
...
\begin{proof}
    ...
    \end{align*}
    generates $\Zext{\alpha, \beta}$ by an argument similar to the proof of \Cref{Ch2:Prop:CharacterisationofAlgInt} (\sorry).

    Now, for any $\gamma \in \Zext{\alpha, \beta}$, we have that
    \begin{align*}
        \gamma \cdot \Zext{\alpha, \beta} \subseteq \Zext{\alpha, \beta}
    \end{align*}
    By \Cref{Ch2:Prop:CharacterisationofAlgInt}(c), $\gamma$ has to be an algebraic integer. In particular, this holds for $\gamma = \alpha + \beta$, $\alpha - \beta$ and $\alpha \cdot \beta$.
\end{proof}

\begin{boxproposition}[Polynomial Property]
...
\begin{proof}
    ...
    \end{align*}
    generates $\Zext{a_0, \ldots, a_{n-1}, \alpha}$ as an abelian group. Since $\alpha$ lies in this subring, by \Cref{Ch2:Prop:CharacterisationofAlgInt}, we can conclude that $\alpha$ is an algebraic integer.
\end{proof}
